const { crc16XModem, intToByte4, u8s2hex, createFormData } =require("./MegaUtils") 
const  { CMD, Config, DeviceInfo } =require("./MegaBleConst") 
...
module.exports= MegaBleBigDataManager
