const  { CMD, STATUS, DeviceInfo, Config } =require("./MegaBleConst") ;
const  MegaBleBigDataManager =require( "./MegaBleBigDataManager");
const  { byte4ToInt, u8s2hex, parseRead } =require("./MegaUtils") ;
const  MegaBleRawdataManager =require("./MegaBleRawdataManager") ;
...
module.exports= MegaBleResponseManager
